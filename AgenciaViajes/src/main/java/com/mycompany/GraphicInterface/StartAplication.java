 ...
 * @author razvanvc
 */
public class StartAplication extends javax.swing.JFrame {

    /**
     * Creates new form StartAplication
     */
    public StartAplication() {
        ...
        //jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("./GraphicResources/fondo.png")));
    }
    ...
    private void initComponents() {
        ...
        lbl_Bienvenida.setFont(new java.awt.Font("Helvetica Neue", 0, 36)); // NOI18N
        lbl_Bienvenida.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_Bienvenida.setLabelFor(this);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StartAplication.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StartAplication().setVisible(true);
            }
        });
    }
